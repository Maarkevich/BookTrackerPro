...
// 🔖 3.8.6: v1 → v2 — в v1 на устройствах закешированы обрезанные
// (битые) Tesseract-файлы; новый номер кеша заставляет перекачать
// полный комплект (tesseract.js + worker + core 5.1.1).
 ...
 * (`btp-ocr-v2`). Используется для подтверждения готовности после
 ...
 * весь проверенный набор OCR-ресурсов во runtime-кеш `btp-ocr-v2`.
 *
