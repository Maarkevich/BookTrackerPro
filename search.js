...
{ id: 'tropes',      ic: 'heartHands', label: 'Тропы' },   // 🆕 v3.8.2
];
// ═══════════════════════════════════════════════
...
* @param {function} config.onFilterTrope    — (tropeName) => void   // 🆕 v3.8.2
*/
...
(b.tropes || []).some(t => t.toLowerCase().includes(q));   // 🆕 v3.8.2
}
function run() {
...
const tropes = data.tropes || [];   // 🆕 v3.8.2
const q = query;
