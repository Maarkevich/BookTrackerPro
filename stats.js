    ...
    <div class="stat-section">
      ...
      <div class="content-card" style="cursor:default">
        ${mostExpensive.book.coverUrl
          ? `<img src="${esc(safeUrl(mostExpensive.book.coverUrl))}" referrerpolicy="no-referrer" style="width:44px;height:66px;border-radius:6px;object-fit:cover"/>`
    ...
    <div class="calendar">
      <div class="calendar-header">
        ...
        <div class="calendar-nav">
          <button id="cal-prev" aria-label="Предыдущий месяц">${icon('chevronLeft', 14)}</button>
          <button id="cal-today" class="btn-small" style="font-size:.72rem;width:auto">Сегодня</button>
          <button id="cal-next" aria-label="Следующий месяц">${icon('chevronRight', 14)}</button>
        </div>
      </div>
