...
//
//    Новое в 3.5.0:
//      — CACHE_NAME → btp-v3.5.0 (сброс кеша при обновлении)
//      — icons.js + search.js в app shell
...
//    Или: bash bump.sh 3.6.0
// ─────────────────────────────────────────────
// ═══════════════════════════════════════════════
//  КОНФИГУРАЦИЯ
// ═══════════════════════════════════════════════
// Имя кеша — МЕНЯЕТСЯ при каждом обновлении!
const CACHE_NAME = 'btp-v3.5.0';
...
`${BASE}/icons.js`,            // 🆕 система иконок
`${BASE}/search.js`,           // 🆕 глобальный поиск
`${BASE}/sw-register.js`,
`${BASE}/manifest.json`,
`${BASE}/version.json`,
`${BASE}/icon-192.png`,
