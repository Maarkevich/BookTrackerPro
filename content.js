...
// 🆕 v3.8.2: Кастомные контролы (uikit.js)
...
// 🆕 v3.8.2: Toggle отчёта показывает/скрывает дату
...
/* 🆕 v3.8.2: индикатор отчётности в карточке */
.cc-report-badge {
