...
//
//    Новое в 3.5.0:
//      — Иконки из единого icons.js (SVG вместо эмодзи в UI)
//      — platformIcon → обёртка над brandIcon
...
// ═══════════════════════════════════════════════
//  КОНСТАНТЫ
//  (эмодзи-поля сохранены для stats.js и других
//   модулей; рендер контент-плана использует SVG
//   из icons.js)
// ═══════════════════════════════════════════════
