...
//
//    Новое в 3.5.0:
//      — verifyCacheFreshness(): сверяет cache из version.json
//        с версией кеша активного SW и форсит обновление при
//        расхождении (защита от «вечно старого кеша»)
//
//    Поток обновления:
...
//  КОНФИГУРАЦИЯ
// ═══════════════════════════════════════════════
// Базовый путь (должен совпадать с BASE в sw.js)
...
// ═══════════════════════════════════════════════
//  3. СВЕЖЕСТЬ КЕША (НОВОЕ в v3.5.0)
// ═══════════════════════════════════════════════
/**
