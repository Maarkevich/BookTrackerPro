...
// ═══════════════════════════════════════════════
//  1. РЕЗОЛВ КОРОТКИХ ССЫЛОК (НОВОЕ в v3.8.1)
// ═══════════════════════════════════════════════
...
// ═══════════════════════════════════════════════
//  2. RETRY С EXPONENTIAL BACKOFF (НОВОЕ в v3.8.1)
// ═══════════════════════════════════════════════
/**
...
// ═══════════════════════════════════════════════
//  3. КАСКАД CORS-ПРОКСИ (НОВОЕ в v3.8.1)
// ═══════════════════════════════════════════════
/**
...
// ═══════════════════════════════════════════════
//  5. ПОЛНЫЙ ПРЕДПРОСМОТР (v3.6.0, улучшено в v3.8.1)
// ═══════════════════════════════════════════════
/**
...
*
* v3.8.1: резолвит короткие ссылки, retry с backoff,
...
export async function extractBookPreview(url, opts = {}) {
  ...
  // v3.8.1: резолвим короткие ссылки
  let resolvedUrl = url;
  if (isShortUrl(url)) {
  ...
  try {
    ...
    // v3.8.1: фолбэк через CORS-прокси
