...
//
//    Новое в 3.5.0:
//      — SVG-иконки из icons.js вместо эмодзи в UI-хроме
//        (кнопки правки/удаления/добавления, плейсхолдеры,
//        стрелка аккордеона фильтров)
//      — Пользовательские эмодзи подборок сохранены
//
//    Логика (из 3.4.0):
...
<!-- Редактирование доступно и для системных подборок -->
...
style="flex-shrink:0" title="Убрать из подборки">
${icon('close', 14)}
</button>
</div>
`).join('')}
...
// Сохраняем порядок (для новых — назначит app.js)
...
/* Блок действий (порядок + правка + удаление) */
.collection-actions {
